    ...
    <form class="w-full flex flex-col gap-3 px-3 py-2 justify-center" action="{{ route('admin.staff.list') }}" method="GET">
        <div class="row flex gap-2">
            <div class="flex flex-col flex-1">
                ...
                <input type="text" name="full_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5" placeholder="Full Name" value="{{ $request['full_name'] ?? '' }}">
            </div>
            <div class="flex flex-col flex-1">
                <label for="countries" class="mb-2 text-sm font-medium text-gray-900">Phone</label>
                <input type="text" name="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5" placeholder="Phone" value="{{ $request['phone'] ?? '' }}">
            </div>
            <div class="flex flex-col flex-1">
                <label for="countries" class="mb-2 text-sm font-medium text-gray-900">Address</label>
                <input type="text" name="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5" placeholder="Address" value="{{ $request['address'] ?? '' }}">
            </div>
        </div>
        <div class="row flex gap-2">
            <div class="flex flex-col flex-1">
        ...
        <div class="row flex justify-end px-3 gap-2">
            ...
            <a href="{{ route('admin.staff.list') }}" class="px-3 py-2 rounded-[5px] text-sm bg-red-600 text-white font-medium w-auto hover:bg-red-500 flex items-center gap-2">
