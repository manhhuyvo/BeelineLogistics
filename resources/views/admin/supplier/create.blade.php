...
<div class="relative sm:rounded-lg">
    ...
    <h2 class="text-2xl font-medium mt-2 mb-3">Add new supplier</h2>
    <div class="w-full mt-4 mb-4 rounded-lg bg-white shadow-lg border-solid border-[1px] border-gray-200 py-1">
        ...
        <form class="w-full flex flex-col gap-3 px-3 py-2 justify-center" action="{{ route('admin.supplier.store') }}" method="POST">
