      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{ route('admin.index') }}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">Beeline Logistics</span>
          </a>
        </div>
            ...
            <div class="flex items-center ml-3">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-gray-100 divide-y divide-gray-200 rounded shadow mr-3" id="dropdown-user">
                ...
                <ul class="py-1" role="none">
                  <li>
                    <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200" role="menuitem">Dashboard</a>
                  </li>
                  <li>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200" role="menuitem">Profile</a>
                  </li>
                  <li>
                    <a href="{{ route('admin.logout') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200" role="menuitem">Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
