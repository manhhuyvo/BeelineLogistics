<div class="flex sm:flex-row sm:items-end flex-col gap-2 flex-1 bg-gray-50 border-solid border-[1px] border-gray-500 rounded-lg py-3 m-0 sm:gap-0 gap-3">
    ...
    <div class="flex flex-col flex-2">
        ...
        <input type="text" name="selected_quantities[]" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5" placeholder="Quantity">
    </div>
