...
<section class="bg-gray-50">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex flex-col items-end mb-6 text-2xl font-semibold text-gray-900">
            <div class="flex items-center">
                <img src="{{ asset('assets/images/logo_landscape.png') }}" class="h-12 mr-4" alt="FlowBite Logo" />
            </div>  
            <span class="text-[14px] italic text-right font-medium text-gray-500">ADMIN PORTAL</span>
        </a>
