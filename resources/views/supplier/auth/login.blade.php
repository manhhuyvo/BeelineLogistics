...
<section class="bg-gray-50">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex flex-col mb-6 text-2xl font-semibold text-gray-900">
            ...
            <span class="text-[14px] italic text-right font-medium text-gray-500">SUPPLIER PORTAL</span>
        </a>
        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('supplier.login') }}">
