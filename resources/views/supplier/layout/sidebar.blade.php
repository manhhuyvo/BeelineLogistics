...
<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{ route('supplier.index') }}" class="flex ml-2 md:mr-24">
            <img src="{{ asset('assets/images/logo_landscape.png') }}" class="h-8 mr-4" alt="FlowBite Logo" />
            <span class="self-center font-semibold sm:text-[16px] sm:flex hidden whitespace-nowrap">Partner Portal And Management System</span>
          </a>
        </div>
        <div class="flex items-center">
            <div class="flex items-center ml-3">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-gray-100 divide-y divide-gray-200 rounded shadow mr-3" id="dropdown-user">
                ...
                <ul role="none">
                  <li>
                    <a href="{{ route('supplier.dashboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 flex items-center" role="menuitem"><i class="fa-sharp fa-solid fa-house text-[12px] mr-2"></i>Dashboard</a>
                  </li>
                  <li>
                    <a href="{{ route('supplier.user.profile.form') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 flex items-center" role="menuitem"><i class="fa-solid fa-user text-[12px] mr-2"></i>Profile</a>
                  </li>
                  <li>
                    <a href="{{ route('supplier.logout') }}" class="block px-4 py-2 font-medium text-sm text-red-500 hover:text-white hover:bg-red-500 flex items-center" role="menuitem"><i class="fa-solid fa-arrow-right-from-bracket text-[12.5px] mr-2"></i>Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
           <li>
              <a href="{{ route('supplier.dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
           ...
           <li>
              ...
              <ul id="sidebar-user-dropdown" class="hidden bg-gray-100 text-sm">
                    ...
                    <li>
                       <a href="{{ route('supplier.fulfillment.list') }}" class="flex items-center w-full py-2 px-[4.5] text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-200">Fulfillment Orders</a>
                    </li>
              </ul>
           </li>
           <li>
  ...
  <div class="p-4 sm:ml-60 bg-white min-h-screen">
     <div class="mt-14 bt-white">
      @include('supplier.layout.breadcrumbs')