        ...
        <form class="w-full flex flex-col gap-3 px-3 py-2 justify-center" action="{{ route('customer.fulfillment.update', ['fulfillment' => $fulfillment['id']]) }}" method="POST">
            ...
            <div class="row flex sm:flex-row flex-col gap-2">
                <div class="flex flex-col flex-1">
                    ...
                    <input id="fulfillment_number" type="text" name="fulfillment_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5" placeholder="Fulfillment Number" value="{{ e($fulfillment['fulfillment_number'] ?? '') }}">
                </div>
                <div class="flex flex-col flex-1">
