...
<div class="relative sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 overflow-x-auto shadow-lg rounded-lg">
        ...
        <tbody style="text-align: center !important;">
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    <span class="font-semibold text-{{ $staffStatusColors[$staff['status']] }}-500">{{ $staffStatuses[$staff['status']] }}</span>
                </td>
                <td class="px-6 py-4">
                    {{ $staff['created_at'] }}
                </td>
