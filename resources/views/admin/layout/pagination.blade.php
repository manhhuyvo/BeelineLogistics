...
<nav class="flex flex-col items-start justify-between py-2 px-[2px]" aria-label="Table navigation">
    ...
    <span class="text-sm font-normal text-gray-500 w-full flex justify-end gap-1">Showing <span class="font-semibold text-gray-900">{{ $pagination['from'] }} - {{ $pagination['to']}}</span> of total <span class="font-semibold text-gray-900">{{ $pagination['total'] }}</span> records</span>
</nav>
<script>
